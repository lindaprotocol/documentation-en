...
The up-to-date LindaGrid API Documentation is at [https://developers.linda.network/docs/linda-grid-intro](https://developers.linda.network/docs/linda-grid-intro).

## Introduction

LindaGrid provides LINDA clients running in the cloud, so you don't have to run one yourself to work with LINDA on your next project.

LindaGrid offers an easy to use hosted API, load balanced full nodes, secure and reliable developer tools with direct access to the LINDA Network.

LindaGrid uses a set of NodeJS apps to talk with Redis and PostgreSQL to provide a simple, fast and reliable query interface for the LINDA API.

LindaGrid supports 2 types of api:

- FullNode & SolidityNode api

LindaGrid supports all the FullNode and SolidityNode api calls, you only need to add the url: `https://api.lindagrid.io/`, like:

`https://api.lindagrid.io/wallet/getnowblock`

- LindaGrid v3 (TG3) api version

As this is the first iteration of the improved LindaGrid, it starts with v1.
Example: `https://api.lindagrid.io/v1`
...
*API:*
`https://api.lindagrid.io/v1/accounts/:address`
*Params:*
...
*Example:*
`https://api.lindagrid.io/v1/accounts/TLCuBEirVzB6V4menLZKw1jfBTFMZbuKq7?only_confirmed=false`


2.&nbsp;Get Transactions By Account Address
*API:*
`https://api.lindagrid.io/v1/accounts/:address/transactions`
*Params:*
...
*Example:*
`https://api.lindagrid.io/v1/accounts/TLCuBEirVzB6V4menLZKw1jfBTFMZbuKq/transactions?only_to=true&only_from=true`


3.&nbsp;Get Account Resources By Address
*API:*
`https://api.lindagrid.io/v1/accounts/:address/resources`
*Params:*
address: The account’s address.
*Example:*
`https://api.lindagrid.io/v1/accounts/TLCuBEirVzB6V4menLZKw1jfBTFMZbuKq/resources`

## Asset APIs

1.&nbsp;Get All Assets
*API:*
`https://api.lindagrid.io/v1/assets`
*Options:*
...
*API:*
`https://api.lindagrid.io/v1/assets/:identifier`
*Params:*
...
*API:*
`https://api.lindagrid.io/v1/assets/:name/list`
*Params:*
...
*API:*
`https://api.lindagrid.io/v1/blocks/:identifier/events`
*Params:*
...
*API:*
`https://api.lindagrid.io/v1/contracts/:address/events`
*Params:*
...
*API:*
`https://api.lindagrid.io/v1/contracts/:address/transactions`
*Params:*
address: The address of the deployed contract.
*Options:*
`only_confirmed` Shows only confirmed. `true` | `false` default `false`.
...
*API:*
`https://api.lindagrid.io/v1/transactions/:id/events`
*Params:*
