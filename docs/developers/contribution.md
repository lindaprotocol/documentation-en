...
## Getting Started as LINDA Community Developers

LINDA is a global, open-source platform for decentralized applications.
...
If you'd like to contribute to LINDA, please fork, fix, commit and send a pull request (PR) for the maintainers to review and merge into the main base. If you wish to submit more complex changes though, please check up with the core developers first on our channel to ensure those changes are in line with the general philosophy of the project and/or get some early feedback which can make both your efforts much lighter as well as our review and merge procedures quick and simple.
...
Please check [Submitting a LIP](./tips.md)

## Coding java-linda

Please check [Coding java-linda](./java-linda.md)

## Reporting Vulnerabilities

We think highly of all the security bugs in the LINDA project seriously. Thank you for improving the security of LINDA project. We really appreciate your efforts and responsible disclosure. We will make every effort to acknowledge your contributions.

Report security bugs at lip.
...
[documentation-en](https://github.com/lindaprotocol/documentation-en) is the English version.
[documentation-zh](https://github.com/lindaprotocol/documentation-zh) is the Chinese version.
