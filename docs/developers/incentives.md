...
Bonus point applies in LINDA incentives programme. Developers can earn points by contributing to LINDA.
...
You can find your points ranking at [Lindascan](https://lindascan.org/#/developersreward).
...
The Top 5 developers who win the cash reward will be announced at Lindascan.

Also, there is a chance to display developers' photos at LINDA official website.
...
Every developer who participates java-linda's development will be honored with a LINDA Honorary Developer Certificate. And we will give a vote of thanks to the developers on LINDA official website.
...
Description: LINDA Improvement Proposal(LIP)
Scope: Any improvement related to LINDA ecosystem, like a new feature, LRC, protocol improvement, programming tool, etc.
Points:
...
Description: To revise, update and add technical documentation related to LINDA network.
...
Scope: java-linda, LINDA ecosystem
Points:
...
Description: To add new features to LINDA network
Scope: java-linda, wallet-cli
Points:
...
Description: To report bugs in online LINDA network
Scope: java-linda, wallet-cli
Points:
...
Description: To fix bugs in online LINDA network
Scope: java-linda, wallet-cli
Points:
...
Description: To find the security risks and enhance the security of LINDA network and ecosystem
Scope: java-linda, LINDA ecosystem
Points:
